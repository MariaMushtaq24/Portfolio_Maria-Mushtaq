            ...
            <div className="bg-black bg-opacity-60 max-w-2xl mx-auto p-8 shadow-2xl">
                ...
                <form className="sm:space-y-2 md:space-y-6">
                    <div className="flex flex-col">
                        ...
                        className="bg-gray-700 text-white py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-600 mb-2" />
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                        ...
                        className="bg-gray-700 text-white py-2 px-4 rounded-md focus:outline-none focus:ring-1 focus:ring-yellow-600 mb-2" />
                    </div>

                    <div className="text-center">
                        <button type="submit" className="bg-yellow-800 text-white py-3 px-8 rounded-lg hover:bg-yellow-600 transition duration-300">
                            Send Message
                        </button>
                    </div>
                </form>
