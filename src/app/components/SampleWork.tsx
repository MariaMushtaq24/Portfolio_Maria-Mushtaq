    ...
    <div className="bg-black bg-[url('/images/bb1.jpg')] bg-cover bg-center px-8 sm:py-16 md:py-28 sm:px-12 md:px-28">
      <section className="flex justify-center gap-5 flex-wrap h-auto w-full p-4">
        ...
        <div className="h-auto w-[450px] flex flex-col items-center rounded-md shadow-2xl bg-black">
          ...
          <div className="p-4 text-center">
            <h3 className="text-yellow-600 font-bold">Content Writing and Copywriting Portfolio</h3>
            <a
        ...
        <div className="h-auto w-[450px] flex flex-col items-center rounded-md shadow-2xl bg-black">
          ...
          ></div>
          <div className="p-4 text-center">
            <h3 className="text-yellow-600 font-bold">Sample Article</h3>
            <a
        ...
        <div className="h-auto w-[450px] flex flex-col items-center rounded-md shadow-2xl bg-black">
          ...
          ></div>
          <div className="p-4 text-center">
            <h3 className="text-yellow-600 font-bold">Branding-Graphic Design</h3>
            <a
      ...
      <section className="flex justify-center gap-5 flex-wrap h-auto w-full p-4">
        ...
        <div className="h-auto w-[450px] flex flex-col items-center rounded-md shadow-2xl bg-black">
          ...
          ></div>
          <div className="p-4 text-center">
            <h3 className="text-yellow-600 font-bold">UI/UX Web-Development</h3>
            <a
        ...
        <div className="h-auto w-[450px] flex flex-col items-center rounded-md shadow-2xl bg-black">
          ...
          ></div>
          <div className="p-4 text-center">
            <h3 className="text-yellow-600 font-bold">Shopify</h3>
            <a
